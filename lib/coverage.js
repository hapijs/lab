...
internals.instrument = function (filename) {
    ...
    var annotate = function (node, parent) {
        ...
        if (node.type === 'ConditionalExpression') {
            ...
            node.set(node.test.source() + '?' + '__$$labStatement(\'' + filename + '\',' + consequent + ',' + line + ',' + node.consequent.source() + ') : __$$labStatement(\'' + filename + '\',' + alternate + ',' + node.alternate.source() + ')');
        }
        ...
        if (node.type === 'LogicalExpression') {
            ...
            node.set('__$$labStatement(\'' + filename + '\',' + left + ',' + line + ',' + node.left.source() + ')' + node.operator + '__$$labStatement(\'' + filename + '\',' + right + ',' + node.right.source() + ')');
        }
    };
