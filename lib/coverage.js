...
internals.prime = function () {
    ...
    require.extensions['.js'] = function (localModule, filename) {
        ...
        var patterns = require.extensions['.js'].patterns || [];
        for (var i = 0, il = patterns.length; i < il; ++i) {
            var pattern = patterns[i];
            if (filename.indexOf(pattern.currentDir) === 0 &&
                filename.indexOf(pattern.modulesDir) !== 0 &&
                filename.indexOf(pattern.testDir) !== 0) {
...
exports.instrument = function (options) {
    ...
    require.extensions['.js'].patterns = [
        {
