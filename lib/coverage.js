...
internals.instrument = function (filename) {
    ...
    var annotate = function (node, parent) {
        ...
        if (trackedTypes.indexOf(node.type) !== -1 &&
            ...
            var consequent = addStatement(line, node.consequent, false);
    ...
    var preamble =
        'if (typeof ' + coverageVar + ' === \'undefined\' || !' + coverageVar + '._line) {' +
            coverageVar + ' = {' +
                'files: {},' +
...
exports.analyze = function (options) {
    ...
    /* $lab:coverage:off$ */ var report = global[internals.global] || { files: {} }; /* $lab:coverage:on$ */
