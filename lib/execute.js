    ...
    Async.forEachSeries(Lab.experiments, function (experiment, nextExperiment) {
        ...
        Async.series({
            ...
            failures: function (next) {
                ...
                internals.executeTests(experiment, emitter, next);
            },
...
internals.executeTests = function (experiment, emitter, callback) {

    var tests = experiment.tests;
    var beforeEaches = experiment.beforeEaches;
    var afterEaches = experiment.afterEaches;
    ...
    Async.forEachSeries(tests || [], function (test, nextTest) {
        ...
        Async.series({
            beforeEaches: function (next) {

                internals.executeDeps(beforeEaches, next);
            },
            test: function (next) {

                runTest(test, next);
            },
            afterEaches: function (next) {

                internals.executeDeps(afterEaches, next);
            }
        }, function (err, results) {
