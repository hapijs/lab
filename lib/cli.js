...
internals.options = function () {
    ...
    var definition = {
        ...
        notify: {
            alias: 'n',
            type: 'boolean',
            description: 'show Growl notifications'
        },
        output: {
            alias: 'o',
            type: 'string',
    ...
    var keys = ['coverage', 'colors', 'dry', 'environment', 'flat', 'grep', 'globals', 'timeout', 'parallel', 'reporter', 'threshold', 'context-timeout', 'sourcemaps', 'notify'];
