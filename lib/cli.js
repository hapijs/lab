...
exports.run = function () {
    ...
    var experiments = internals.traverse(settings.paths);
    return Runner.report(experiments, settings);
};
...
internals.options = function () {
    ...
    var keys = ['coverage', 'color', 'dry', 'environment', 'grep', 'id', 'globals', 'leaks', 'timeout', 'output', 'parallel', 'reporter', 'threshold'];
