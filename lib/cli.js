...
internals.options = function () {
    ...
    var definition = {
        ...
        transform: {
            alias: ['T', 'transform'],
            type: 'string',
            description: 'module that exports a list of extensions and a source transform function'
        },
        threshold: {
            alias: 't',
            type: 'number',
    ...
    var keys = ['coverage', 'colors', 'dry', 'environment', 'flat', 'grep', 'globals', 'timeout', 'parallel', 'reporter', 'threshold', 'context-timeout', 'sourcemaps', 'lint', 'linter', 'transform'];
    ...
    if (options.transform) {
        ...
        if (Array.isArray(transform.extensions) && typeof transform.transform === 'function') {
            ...
            console.error('transform module must export extensions (array of file extensions) & transform (function that transforms the code');
            process.exit(1);
        }
    }
