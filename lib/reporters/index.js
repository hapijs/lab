...
internals.requireMultiple = function (reporters) {
...
exports.generate = function (options) {
    ...
    var Proto = internals.protos[options.reporter] || internals.requireMultiple(options.reporter) || internals.requireReporter(options.reporter);
