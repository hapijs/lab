...
exports.experiment = exports.describe = function (title /*, options, fn */) {
    ...
    if (exports.only) {
        if (!child.parent.options.only) {
            // Enforce only one path the be the "only", cannot have multiple ones
            child.options.only = false;
        }
    } else if (child.options.only) {
        exports.only = child.parent;
    }
...
exports.experiment.skip = function (title /*, options, fn */) {

    var options = arguments.length === 3 ? arguments[1] : {};
    var fn = arguments.length === 3 ? arguments[2] : arguments[1];

    exports.experiment(title, internals.mergeOptions({ skip: true }, options), fn);
};

exports.experiment.only = function (title /*, options, fn */) {

    var options = arguments.length === 3 ? arguments[1] : {};
    var fn = arguments.length === 3 ? arguments[2] : arguments[1];

    exports.experiment(title, internals.mergeOptions({ only: true }, options), fn);
};
...
exports.test = exports.it = function (title /*, options, fn */) {
    ...
    if (exports.only) {
        if (!internals.current.options.only) {
            // Enforce only one path the be the "only", cannot have multiple ones
            test.options.only = false;
        }
    } else if (test.options.only) {
        exports.only = internals.current;
    }
...
exports.test.skip = function (title /*, options, fn */) {

    var options = arguments.length === 3 ? arguments[1] : {};
    var fn = arguments.length === 3 ? arguments[2] : arguments[1];

    exports.test(title, internals.mergeOptions({ skip: true }, options), fn);
};


exports.test.only = function (title /*, options, fn */) {

    var options = arguments.length === 3 ? arguments[1] : {};
    var fn = arguments.length === 3 ? arguments[2] : arguments[1];

    exports.test(title, internals.mergeOptions({ only: true }, options), fn);
};
