...
describe('math', function() {
  ...
  describe('addition', function () {
      ...
      describe.only('nested addition', function() {
        ...
        it('returns true when 4 + 4 equals 8', function (done) {
  ...
  describe('subtract', function () {
      ...
      it('returns true when 2 - 1 equals 1', function (done) {

          expect(2-1).to.equal(1);
          done();
      });

      describe.only('nested subtract', function () {
